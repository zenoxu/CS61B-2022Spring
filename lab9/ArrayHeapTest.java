...
public class ArrayHeapTest {
    ...
    public void insertAscending() {
        ...
        for (int i = 0; i < items.length; i++) {
            assertEquals(String.format("%d-th peek call", i), items[i], hp.peek());
            assertEquals(String.format("%d-th removeMin call", i), items[i], hp.removeMin());
        }
    }
    ...
    public void insertDescending() {
        ...
        assertEquals("Size should be 4", 4, hp.size());
        for (int i = 0; i < items.length; i++) {
            assertEquals(String.format("%d-th peek call", i), items[items.length - 1 - i], hp.peek());
            assertEquals(String.format("%d-th removeMin call", i), items[items.length - 1 - i], hp.removeMin());
        }
    }

...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        String current = Utils.readContentsAsString(Dog.DOG_STORY);
        if (!current.equals("")) {
            Utils.writeContents(Dog.DOG_STORY, current + "\r\n" + args[1]);
        } else {
            Utils.writeContents(Dog.DOG_STORY, args[1]);
        }
        System.out.println(Utils.readContentsAsString(Dog.DOG_STORY));
        // FIXME
    }

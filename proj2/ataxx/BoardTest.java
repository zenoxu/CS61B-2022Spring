...
public class BoardTest {
    ...
    public void test4() {
        ...
        makeMoves(b, TEST4);
        b.makeMove('d', '4', 'd', '3');
        assertFalse(b.canMove(BLUE));
        assertFalse(b.canMove(RED));
        assertEquals(b.getWinner(), RED);
        checkBoard(b, TEST4RESULT);
    ...
    private static final String[] TEST4 = {
        "a7-b6", "g7-f6", "g1-f2", "a1-b2", "b6-c5",
        "f6-e5", "f2-e3", "b2-c3", "c5-d4",
        "f6-d6", "d4-d5", "g7-f6", "d6-d7", "b2-d1",
        "c3-b2", "d1-d2"
    };

    private static final PieceColor[][] TEST4RESULT = {

...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
                              int targetYear) {
        return presentValue*pow((1+rate*0.01),numYears(targetYear));
    }
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        return futureValue(presentValue,rate,targetYear)*pow((1-0.01*inflationRate),numYears(targetYear));
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        return totalSavings(perYear,targetYear,rate)*pow((1-inflationRate*0.01),numYears(targetYear));
    }
    ...
    static void printDollarFV(int targetYear, double returnRate,
                              double inflationRate) {
        double nominalDollarValue = 1*pow((1+0.01*returnRate),numYears(targetYear)); // replace 0 with your code
        double realDollarValue = nominalDollarValue*pow((1-0.01*inflationRate),numYears(targetYear));    // replace 0 with your code
    ...
    static void printSavingsFV(int targetYear, double returnRate,
        ...
        double realSavings =nominalSavings*pow((1-0.01*inflationRate),numYears(targetYear));    // replace 0 with your code
